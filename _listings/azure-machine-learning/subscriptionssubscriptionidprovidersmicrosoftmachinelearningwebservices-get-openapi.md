...
x-complete: 0
info:
  title: Azure Machine Learning API Web Services List By Subscription Id
...
paths:
  ...
  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/webServices:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftmachinelearningwebservices-get
      parameters:
      - in: query
        name: $skiptoken
  ...
  /subscriptions/{subscriptionId}/providers/Microsoft.MachineLearning/webServices:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidprovidersmicrosoftmachinelearningwebservices-get
      parameters:
      - in: query
        name: $skiptoken
        description: Continuation token for pagination
